    ...
    <div id="usersModal" class="modal">
        <div class="modal-content">
            ...
            <ul>
                ...
                <li><a href="admin/export_users.php" class="btn btn-primary">Exporter la liste en CSV</a></li>
                <li><a href="admin/export_users_pdf.php" class="btn btn-secondary">Exporter la liste en PDF</a></li>
