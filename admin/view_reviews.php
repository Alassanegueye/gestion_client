...
<body>
    ...
    <main>
        ...
        if ($result->num_rows > 0) {
            echo "<table><tr><th>Nom</th><th>Avis</th><th>Réponse</th><th>Date</th></tr>";
            while($row = $result->fetch_assoc()) {
                echo "<tr><td>" . $row['customer_name'] . "</td><td>" . $row['review_text'] . "</td><td>" . $row['reply_text'] . "</td><td>" . $row['review_date'] . "</td></tr>";
            }
            echo "</table>";
        } else {
